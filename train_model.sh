...
CUDA_VISIBLE_DEVICES=3,2,1 python3 train_encoder.py --method protonet --dataset fwt_train_wiki --testset fwt_val_pubmed --name only2dCnn_att_euc --warmup only2dCnn --stop_epoch 100 | tee log_train_model/log_only2dCnn_att_euc.txt &
#
