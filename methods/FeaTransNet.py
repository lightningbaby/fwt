...
------------      -------    --------    -----------
2020-04-22 22:28   tangyubao      1.0         None
'''
...
class FeaTransNet(nn.Module):
  def __init__(self, params, tf_path=None, change_way=True):
    super(FeaTransNet, self).__init__()
    ...
    re_backbone.FeatureTransformation1d_ft.feature_augment = True
    re_backbone.ConvBlock.maml = True
    re_backbone.SimpleBlock.maml = True
    ...
    if params.method == 'protonet':
      ...
      re_backbone.LSTMCell.maml = True
